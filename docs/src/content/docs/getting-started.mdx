...
1. `starlight-custom-blocks` is a Starlight [plugin](https://starlight.astro.build/reference/plugins/). Install it by running the following command in your terminal:
   ...
   ```sh
   npm install starlight-custom-blocks
   ```
   ...
   ```sh
   pnpm add starlight-custom-blocks
   ```
   ...
   ```sh
   yarn add starlight-custom-blocks
   ```
